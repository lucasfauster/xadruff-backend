...
import java.net.URL;
public class CreategameandmoveapieceTest {
  ...
  @Test
  public void creategameandmoveapiece() {
    ...
    driver.findElement(By.cssSelector(".submenu-option:nth-child(1) .menu-piece")).click();
    driver.findElement(By.cssSelector("#g2 > .w")).click();
    driver.findElement(By.id("g4")).click();
    driver.close();
  }
}
