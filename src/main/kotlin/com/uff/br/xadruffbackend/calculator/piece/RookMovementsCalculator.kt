...
class RookMovementsCalculator(
    ...
    data class ColumnsAndLinesFree(
        ...
        fun isAllDirectionsOccupiedByAllies(): Boolean =
            !(upColumnFree || downColumnFree || rightLineFree || leftLineFree)
    }
    ...
    private fun ColumnsAndLinesFree.verifyIfHasAlliesInAllDirections(line: Int, col: Int, index: Int) {
